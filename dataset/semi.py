...
class SemiDataset(Dataset):
    ...
    def __getitem__(self, item):
        id = self.ids[item]
        # .convert('RGB') is a no-op for the RGB Pascal/Cityscapes images but
        # guards against palette-mode / single-channel PNGs, which would
        # otherwise break broadcasting against the 3-channel normalisation.
